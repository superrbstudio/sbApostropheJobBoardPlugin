...
abstract class PluginsbJobBoardApplicationForm extends BasesbJobBoardApplicationForm
{
	public function configure()
	{
		$this->setWidgets(array(
			'name' => new sfWidgetFormInputText(array('default' => 'Name')),
			'email' => new sfWidgetFormInputText(array('default' => 'Email address')),
			'phone_number' => new sfWidgetFormInputText(array('default' => 'Phone number')),
			'job_type' => new sfWidgetFormInputText(array('default' => 'Job type')),
