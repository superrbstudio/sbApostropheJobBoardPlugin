...
class sbJobBoardJobSearchForm extends sfForm
{
	public function configure()
	{
		...
		$times     = array(date('Y-m-d', strtotime('-2 weeks')) => 'Last 14 days', date('Y-m-d', strtotime('-1 week')) => 'Last 7 days', date('Y-m-d', strtotime('yesterday')) => 'Yesterday', date('Y-m-d', strtotime("today")) => 'Today');
